...
Os quatro nós à esquerda ($X_1$ a $X_4$) representam simplesmente os valores dos [dados de entrada]{.hl} da rede. Apesar de não acontecer nenhuma computação nestes nós, alguns livros consideram que estes nós formam a [camada de entrada]{.hl}.
